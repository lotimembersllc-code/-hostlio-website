...
TYPES = {
"tr": [
 dict(key="t-guesthouse", img=("hostlio-phone","Masa lambalı, sıcak bir pansiyon odası"),
 ...
 dict(key="t-boutique", img=("brand-courtyard","Bugenvilli ve havuzlu butik otel avlusu", 880, 804),
 ...
 dict(key="t-apart", img=("hostlio-room","Aydınlık, beyaz nevresimli apart daire"),
 ...
 dict(key="t-hostel", img=("hostlio-lobby","Ahşap panelli, ortak alanlı konaklama lobisi"),
...
"en": [
 dict(key="t-guesthouse", img=("hostlio-phone","A warm guesthouse room with a desk lamp"),
 ...
 dict(key="t-boutique", img=("brand-courtyard","Boutique hotel courtyard with a pool and bougainvillea", 880, 804),
 ...
 dict(key="t-apart", img=("hostlio-room","Bright apartment with white bedding"),
 ...
 dict(key="t-hostel", img=("hostlio-lobby","Lobby with wood panelling and shared seating"),

...
"tr": dict(
  ...
  try_="Ücretsiz dene", demo="Demo iste", via="Channex ile bağlı:", more="ve 100+ kanal",
  ...
  st=[("Tüm misafir mesajları tek gelen kutusunda","WhatsApp ve OTA gelen kutusu mesajları (Booking.com, Airbnb, Expedia) bir arada. Lio otelinizin bilgileriyle cevaplar, siz sadece gerekeni görürsünüz.",["30+ dilde otomatik yanıt","Her mesajın yanında rezervasyon bilgisi","Emin olmadığı soruyu size devreder"],"ai","Lio nasıl çalışır"),
      ...
      ("100+ kanal, tek müsaitlik","Channex altyapısıyla çift yönlü senkron. Bir kanalda satılan oda diğerlerinde anında kapanır.",["Fiyat ve kısıtlamalar tek ekrandan","Yeni rezervasyon ve iptaller otomatik","Overbooking riski yok"],"channel","Kanal yöneticisi"),
  ...
  b_chan=("Kanal yöneticisi","Channex ile 100+ satış kanalı, tek müsaitlik."),
  ...
  ai_cards=[("van","Satış yapar","Havalimanı transferi ve turu doğru anda önerir, talebi rezervasyona bağlar."),("hand-arrow-up","Gerekeni size bırakır","İndirim, şikâyet ya da özel istek gibi karar gerektiren mesajları personele iletir."),("calendar-dots","Rezervasyonu tanır","Hangi misafir, hangi oda, hangi tarih; her cevabı rezervasyon bilgisiyle verir.")],
...
"en": dict(
  ...
  try_="Try it free", demo="Book a demo", via="Connected through Channex:", more="and 100+ more",
  ...
  st=[("Every guest message in one inbox","WhatsApp and OTA inbox messages (Booking.com, Airbnb, Expedia) together. Lio answers with your hotel's information, and you only see what needs you.",["Automatic replies in 30+ languages","Reservation details beside every message","Hands over what it isn't sure about"],"ai","How Lio works"),
      ...
      ("100+ channels, one availability","Two-way sync through Channex. A room sold on one channel closes on the others instantly.",["Rates and restrictions from one screen","New bookings and cancellations flow in","No overbooking risk"],"channel","Channel manager"),
  ...
  b_chan=("Channel manager","100+ sales channels through Channex, one availability."),
  ...
  ai_cards=[("van","Sells for you","Offers airport transfers and tours at the right moment and attaches the request to the booking."),("hand-arrow-up","Knows when to hand over","Messages that need a decision, like discounts, complaints or special requests, go to your staff."),("calendar-dots","Knows the booking","Which guest, which room, which dates: every reply uses the reservation details.")],
...
<div class="cta-row">{btn(t["try_"], SIGNUP_URL)}{btn(t["demo"], U("contact"), "ghost")}</div>
